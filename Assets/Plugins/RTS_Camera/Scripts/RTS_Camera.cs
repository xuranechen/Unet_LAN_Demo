...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float mouseRotationSpeed = 0.01f;
        ...
        private void Rotation()
        {
            ...
            {
                // Pitch
                m_Transform.rotation *= Quaternion.AngleAxis( -Input.GetAxis("Mouse Y") * mouseRotationSpeed,Vector3.right);

                // Paw
                m_Transform.rotation = Quaternion.Euler(transform.eulerAngles.x,transform.eulerAngles.y + Input.GetAxis("Mouse X") * mouseRotationSpeed,transform.eulerAngles.z);
            }
        }
